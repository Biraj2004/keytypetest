/**
 * @file words.ts
 * @description Curated pool of 1000 common English words.
 *
 * Attribution:
 * Derived from the MIT-licensed google-10000-english list (https://github.com/first20hours/google-10000-english).
 * This subset is restricted to common, public-domain English words suitable for typing practice.
 */
...
export const WORD_POOL: string[] = [
  ...
  "region", "size", "vary", "settle", "speak", "weight", "general", "ice", "matter", "circle",
  ...
  "caught", "period", "board", "radio", "spoke", "atom", "human", "history", "effect", "electric",
  "expect", "crop", "modern", "element", "hit", "student", "corner", "party", "supply", "bone",
  "rail", "imagine", "provide", "agree", "thus", "gentle", "woman", "captain", "practice", "separate",
  "difficult", "doctor", "please", "protect", "noon", "whose", "locate", "ring", "character", "insect",
  "caught", "period", "board", "radio", "spoke", "atom", "human", "history", "effect", "electric",
  "expect", "crop", "modern", "element", "hit", "student", "corner", "party", "supply", "bone",
  ...
  "shoulders", "spread", "arrange", "camp", "invent", "cotton", "born", "determine", "quart", "nine",
  ...
  "nose", "plural", "anger", "claim", "continent", "lady", "yard", "rise", "bad", "blow",
  "oil", "blood", "touch", "grew", "cent", "mix", "team", "wire", "cost", "lost",
  "brown", "wear", "garden", "equal", "sent", "choose", "fell", "fit", "flow", "fair",
  "bank", "collect", "save", "control", "decimal", "gentle", "woman", "captain", "practice", "separate",
  "difficult", "doctor", "please", "protect", "noon", "whose", "locate", "ring", "character", "insect",
  ...
  "women", "season", "solution", "magnet", "silver", "thank", "branch", "match", "suffix", "fig",
  "especially", "huge", "sister", "steel", "discuss", "forward", "similar", "guide", "experience", "score",
  ...
  "season", "solution", "magnet", "silver", "thank", "branch", "match", "suffix", "fig", "especially",
  ...
  "teeth", "shell", "neck", "deserve", "supply", "intent", "focus", "practice", "custom", "design"
];
